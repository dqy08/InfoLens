import { getByteSurprisalColor, getSemanticSimilarityColor, MINIMAP_COLOR_FACTOR, SEMANTIC_MINIMAP_COLOR_FACTOR } from '../utils/SurprisalColorConfig';
import { isNarrowScreen } from '../utils/responsive';
import { calculateSurprisalDensity, isFiniteNumber } from '../utils/Util';
